...
class PurchaseStateChangeRegistryReportWizard(models.TransientModel):
    _name = "purchase.state.change.registry.report.wizard"
    _description = "Purchase State Change Registry Report Wizard"
    ...
    def action_show_records(self):
        ...
        return {
            ...
            "name": "Reporte de Registros de Cambio de Estado - Compras",
            "res_model": "purchase.state.change.registry.report.wizard",
            "view_mode": "form",
            "res_id": self.id,
            "target": "new",
        }
